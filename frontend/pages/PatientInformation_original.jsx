    ...
    <div className="patient-layout">
      ...
      {!patient ? (
        ...
        <div className="sections">
          ...
          <Section number="3" title="Renal Drugs History">
            <CurrentMedication patient={patient} />
          </Section>

          <Section number="4" title="Complete Drugs History">
            <AllMedication patient={patient} />
          </Section>

          <Section number="3" title="Suggested Medication by LLM [ chatgpt/claude/any free medical site ]">
            <CurrentMedication medications={patient} />
          </Section>

          <Section number="4" title="Risk score by SHAP/NICE/Any other NHS/British Guideline">
            <RiskScore risk={patient} />
          </Section>

          <Section number="5" title="Alerts and flags">
            <Alerts alerts={patient} />
          </Section>

          <Section number="6" title="Possible medication and related issues [Drug Drug Interaction details]">
            <MedicationIssues issues={patient} />
          </Section>

          <Section number="7" title="Prediction explanation">
            <PredictionExplanation text={patient} />
          </Section> 
        </div>
      )}
    </div>
